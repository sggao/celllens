...
class LENS_Dataset(Dataset):
    ...
    def __init__(self,
        ...
        df : pandas dataframe containing information:
            ...
            - 2D cell location information (x,y):
                ...
                @ if will be training LENS-CNN (extracting morphology information from image files), the supplied 2D cell
        ...
        features_list : list(str)
            List of feature names to be used in CellLENS process
    ...
    def initialize(self,
        ...
        -feature edges from similarity, used in LENS-GNN
    ...
    def prepare_images(self,
        ...
        The images will be saved in the pre-specified saving directory in function '.LENS_Dataset'.
        Parameters
        ----------
